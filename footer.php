<footer class="bg-light py-4 mt-5 border-top">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <h5>ConnectHub</h5>
        <p class="text-muted">Fostering partnerships and collaboration among university-based organizations.</p>
      </div>
      <div class="col-md-4">
        <h5>Quick Links</h5>
        <ul class="list-unstyled">
          <li><a href="index.php" class="text-decoration-none">Home</a></li>
          <li><a href="events.php" class="text-decoration-none">Events</a></li>
          <li><a href="organizations.php" class="text-decoration-none">Organizations</a></li>
    ...
    <div class="row mt-3">
      <div class="col-12 text-center">
        <p class="text-muted mb-0">© <?= date('Y') ?> ConnectHub. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
